...
//	Function to pull in the json from the url.
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/sampleQuery", null, function(d) {
        var data = d.data;
...
function loadRoutes(){
    var counter = 0
    var a = $.getJSON("http://137.43.49.41:8000/dublinbuspredict/loadRoutesForMap", null, function(d) {
...
//            $('#dropdown-list-5').append($('<li></li>').val(p).html('<a onclick=getStopsStartingFromSource2("' + p + '")>' + p + '</a>'));
    ...
    var b = $.getJSON("http://137.43.49.41:8000/dublinbuspredict/getInfoNextPage", null, function(d) {
        route = d['route'];
        source = d['source'];
...
function getStops2(route) {
    ...
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/pilotRoutes", {"route":route}, function(d) {
...
function getStopsDest2(source) {
    ...
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/pilotDest", {"route":route, "source":source}, function(d) {
...
function getStopsStartingFromSource2(stop){
    ...
    document.getElementById("search-box-6").value = "";
    document.getElementById('spinner6').style.display = 'block';
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/getStopsStartingFromSource", {"source":stop}, function(d) {
        $.each(d['stops'], function(i, p) {
...
function getStopsDestExtraRoute2(route){
    ...
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/getStopsDestExtraRoute", {"source":source, "dest":dest}, function(d) {
...
function getExtraRoute2(route){
	...
	$.getJSON("http://137.43.49.41:8000/dublinbuspredict/setStopsForMaps", {"route":route, "source":sourceInput, "dest":destInput}, function() {});
}
...
function loadOrigin2(){
    ...
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/loadRoutesForMap", null, function(d) {
             $.each(d['list_stops'], function(i, p) {
                list_origin_dropdown.push(p);
             });
    });
...
function getPredictions(route, source, destination){
    ...
    var buses = 0
    var direction = 0
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/getNumberBuses", {"route":route, "source":source}, function(d) {
        buses = d['buses']
        ...
        if (buses != 'No buses found!'){
            $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runModel", {"route":route, "source":source, "destination":destination, "direction":direction, "position":0}, function(d) {
                var d2 = d.info_buses;
                getPredictedTimes(d.info_buses[0], d.info_stops);
                document.getElementById('spinner-result-0').style.display = 'none';
                var bus0, bus1, bus2;
                if (buses > 1){
                    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runModel", {"route":route, "source":source, "destination":destination, "direction":direction, "position":1}, function(d) {
                        var d2 = d.info_buses;
                        getPredictedTimes(d.info_buses[0], d.info_stops);
                        document.getElementById('spinner-result-1').style.display = 'none';
                        var bus0, bus1, bus2;
                        if (buses > 2){
                            $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runModel", {"route":route, "source":source, "destination":destination, "direction":direction, "position":2}, function(d) {
                                var d2 = d.info_buses;
                                getPredictedTimes(d.info_buses[0], d.info_stops);
...
function getPredictionSchedule(route, source, destination, date, time){
    var busNum = 0;
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runQueries", {"route":route, "source":source, "destination":destination, "date":date, "time":time}, function(d) {
        ...
        document.getElementById('spinner-result-1').style.display = 'block';
        document.getElementById('spinner-result-2').style.display = 'block';
        $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runPlanner", {"route":route, "source":source, "destination":destination, "date":date, "time":time, 'bus':bus1, 'stops': stops1}, function(d1) {
            if (d1 === "No buses found1!"){
                ...
                busNum += 1;
                document.getElementById('spinner-result-0').style.display = 'none';
                $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runPlanner", {"route":route, "source":source, "destination":destination, "date":date, "time":time, 'bus':bus2, 'stops': stops2}, function(d2) {
                    ...
                    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/runPlanner", {"route":route, "source":source, "destination":destination, "date":date, "time":time, 'bus':bus3, 'stops': stops3}, function(d3) {
