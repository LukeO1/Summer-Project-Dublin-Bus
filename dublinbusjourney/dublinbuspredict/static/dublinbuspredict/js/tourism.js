...
function tourismMap(){
    $.getJSON("http://137.43.49.41:8000/dublinbuspredict/getTourist", null, function(d) {
...
$.getJSON("http://137.43.49.41:8000/dublinbuspredict/getTouristRoutes", null, function(d2) {
	routesData = d2.data;
});
}
